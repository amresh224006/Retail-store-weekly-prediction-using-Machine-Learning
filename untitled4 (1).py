...
Original file is located at
    https://colab.research.google.com/drive/16i13iCqK58FUngA57TRgqayHcRD5ckYb
"""
...
with tab1:
    ...
    with col2:
        col2.image(Image.open(r"/content/cyber-monday.png"), width=300)

    # with col7:
    #     col7.image(Image.open(r"C:\Users\Muthusamy\Pictures\logo\download.jpg"), width=300)
...
with tab2:
    ...
    with tab3:
        ...
        with col9:
            st.image(Image.open(r"/content/cyber-monday.png"), width=300)